...
const getWeatherdata = async () => {
    try {
        const weatherData = await axios.get(`https://api.openweathermap.org/data/2.5/onecall?lat=${route.query.lat}&lon=${route.query.lng}&lang=kr&exclude={part}&appid=${API_KEY}&units=imperial`)
